                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Carousel Menu</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                <table id="List" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><img src="../../uploads/carousel-menu/<?= $row['gambar'] ?>" width="100px"></td>
                                            <td>
                                        ...
                                        <div class="modal fade" id="editDataMenu<?= $row['id_carousel'] ?>" tabindex="-1" aria-labelledby="editDataMenu<?= $row['id_carousel'] ?>Label" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="page.php?mod=updateCarouselMenu" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="tambahDataCarousel" tabindex="-1" aria-labelledby="tambahDataMenuLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="page.php?mod=addCarouselMenu" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="image" class="form-label">Gambar</label>
                                <input type="file" name="file">
